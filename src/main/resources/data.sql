...
create table Usuarios(idUsuario int AUTO_INCREMENT PRIMARY KEY, usuario varchar(250), contrasena varchar(250), rol varchar(25) not null, nombre varchar(250),correo varchar(250),disponible int(1));
...
insert into Usuarios (usuario, contrasena,rol, nombre, correo,disponible) values ('juan123','123','ROL_C','Juan Torres','juan@mail.com',1),('joseadmin','123','ROL_A','Jose Benavides', 'jose@mail.com',1);
