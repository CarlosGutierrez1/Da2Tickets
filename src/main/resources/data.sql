...
create table Tickets(idTicket int AUTO_INCREMENT PRIMARY KEY, idCliente int not null, idEncargado int, tipoSoporte varchar(50), idPrioridad int, numTicket varchar(250), descripcion varchar(250), estado int(1));
